...
export default class Main extends Component {
  render() {
        return(
            <div>
        <h1>I am a Main Component</h1>
        <img style={{
                borderRadius:'20px',     
            }} src="/images/coforge.jpg" alt="pms" 
            height={400} width={400}></img>

        <p>Coforge Limited, formerly known as NIIT Technologies Limited, is an Indian multinational information technology company based in Noida. 
...
In September 2012, the company launched Crew Wings, an application for Airline Cabin Crew Members. In the same year, the company acquired Sabre Holdings' Philippines Development Center. </p>
        <p>
